...
window.recoverStoredTranscripts=function(){
  ...
  }).catch(function(e){transcriptRecoveryRunning=false;if(/session expired|authentication required|please log back in/i.test(String(e.message||e))){renderTranscriptAuthExpired();return null;}renderTranscriptError(e.message);throw e;});
};
